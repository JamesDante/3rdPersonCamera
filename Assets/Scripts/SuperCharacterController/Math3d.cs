...
public class Math3d : MonoBehaviour
{
    ...
    public static bool LineLineIntersection(out Vector3 intersection, Vector3 linePoint1, Vector3 lineVec1, Vector3 linePoint2, Vector3 lineVec2)
    {
        ...
        //Note: sqrMagnitude does x*x+y*y+z*z on the _input vector.
    ...
    public static float SignedDotProduct(Vector3 vectorA, Vector3 vectorB, Vector3 normal)
    {
        ...
        //Use the geometry object normal and one of the _input vectors to calculate the perpendicular vector
        perpVector = Vector3.Cross(normal, vectorA);

        //Now calculate the dot product between the perpendicular vector (perpVector) and the other _input vector
    ...
    public static float AngleVectorPlane(Vector3 vector, Vector3 normal)
    {
        ...
        //calculate the the dot product between the two _input vectors. This gives the cosine between the two vectors
    ...
    public static void PlaneFrom3Points(out Vector3 planeNormal, out Vector3 planePoint, Vector3 pointA, Vector3 pointB, Vector3 pointC)
    {
        ...
        //Make two vectors from the 3 _input points, originating from point A
    ...
    //object with the _input vectors, a custom direction can be used instead of the fixed forward and up vectors.
    ...
    public static void LookRotationExtended(ref GameObject gameObjectInOut, Vector3 alignWithVector, Vector3 alignWithNormal, Vector3 customForward, Vector3 customUp)
    {
        ...
        //Set the rotation of the _destination
